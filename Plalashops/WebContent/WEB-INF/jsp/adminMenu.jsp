	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li id='itemGroupProductPage' <%= menuSelect.equals("GroupProduct") ? "class='active'" : "" %> ><a href="/Plalashops/adminGroupProduct.html">Group Product</a></li>
				...
				<li id='itemoederManagementPage' <%= menuSelect.equals("Order") ? "class='active'" : "" %> ><a >Oeder Management</a></li>
			</ul>
		</div>
	</nav>
